...
{
  perform_selection_op (s, "Invert selection", ss_invert, NULL, NULL);
}
...
{
  perform_selection_op (s, "Select all", ss_select_all, NULL, NULL);
}
...
{
  perform_selection_op (s, "Select none", ss_select_none, NULL, NULL);
}
...
#define BUF_LEN 64
  ...
  perform_selection_op (s, buf, ssits, NULL, NULL);
}
...
#define BUF_LEN 64
  ...
  perform_selection_op (s, buf, ssrwts, NULL, NULL);
}
